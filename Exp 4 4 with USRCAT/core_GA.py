...
if __name__ == '__main__':
    ...
    file_name      = '/content/GA/4.4/delta_0.4/Dinaciclib_SMILES.txt' #Location of file with starting SMILES
        ...
        for i in range(1):
            for beta in beta_preference:
                ...
                smiles_all_counter = initiate_ga(    num_generations            = 20,
                                                     ...
                                                     device                     = 'cpu', 
                                                     properties_calc_ls         = ['logP', 'SAS', 'RingP', 'SIMILR', 'USRSim'],             # None: No properties ; 'logP', 'SAS', 'RingP', 'USRSim' 
